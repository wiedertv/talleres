    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
                ...
                <div className="container mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <div className="flex items-center space-x-3">
                            <Button
                                variant="outline"
                                className="rounded-full border-blue-600 text-blue-600 hover:bg-blue-50/50"
                            >
                                Iniciar Sesión
                            </Button>
                            <motion.div whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                                <Button
                                    className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full shadow-lg hover:shadow-blue-400/30">
                                    Registrarse
                                </Button>
                            </motion.div>
                        </div>
                        ...
                        >
                            <div className="container mx-auto px-4 py-3 flex flex-col space-y-3">
                                ...
                                <div className="flex flex-col space-y-2 pt-2 border-t border-gray-200/50">
                                    ...
                                    <Button
                                        className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full">
                                        Registrarse
                                    </Button>
                                </div>
                            </div>
            ...
            <section className="pt-28 md:pt-36 pb-20 relative overflow-hidden">
                ...
                <div
                    className="absolute inset-0 bg-[url('https://readdy.ai/api/search-image?query=abstract%20tech%20background%20with%20circuits%20and%20blue%20glow')] bg-cover bg-center opacity-20"/>
                ...
                <div className="container mx-auto px-4 relative z-20">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                            Revoluciona tu <span
                            className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">taller automotriz</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <motion.div whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                                <Button
                                    className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white text-lg py-6 px-8 rounded-full shadow-lg hover:shadow-blue-400/30">
                        ...
                        <div className="mt-10 flex items-center">
                            ...
                            <p className="ml-4 text-gray-600">
                                Más de <span className="font-bold text-gray-800">2,500 talleres</span> ya confían en
                                nosotros
                            </p>
                        </div>
                    </motion.div>
            ...
            <section id="beneficios" className="py-16 md:py-24 relative">
                <div
                    className="absolute inset-0 bg-[url('https://readdy.ai/api/search-image?query=abstract%20tech%20grid%20background%20with%20blue%20glow')] bg-cover opacity-5"/>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{once: true}}
                                whileHover={{y: -10}}
                                className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-100/50 hover:shadow-blue-100/50 transition-all duration-300"
                            >
                                <div
                                    className="w-14 h-14 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center mb-6 mx-auto shadow-md">
            ...
            <section id="caracteristicas" className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    {[
                        {
                            title: "Agenda Inteligente",
                            description: "Optimiza los tiempos de tu taller con nuestro sistema de citas que considera la duración de cada servicio, disponibilidad de mecánicos y recursos necesarios.",
                            image: "https://readdy.ai/api/search-image?query=modern%20auto%20repair%20shop%20scheduling%20interface%20on%20tablet",
                            features: ["Recordatorios automáticos", "Asignación de mecánicos", "Historial de servicios"]
                        },
                        {
                            title: "Gestión de Clientes 360°",
                            description: "Mantén toda la información de tus clientes organizada, incluyendo historial de servicios, preferencias y datos de contacto en un solo lugar.",
                            image: "https://readdy.ai/api/search-image?query=automotive%20customer%20management%20dashboard%20on%20laptop",
                            features: ["Perfiles completos", "Historial de vehículos", "Comunicación integrada"]
                        },
                        {
                            title: "Control Financiero",
                            description: "Gestiona facturas, presupuestos y pagos con nuestro sistema integrado que genera informes automáticos para mantener tu negocio saludable.",
                            image: "https://readdy.ai/api/search-image?query=automotive%20shop%20financial%20dashboard%20on%20desktop",
                        ...
                        <motion.div
                            ...
                            viewport={{once: true}}
                            className={`flex flex-col ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-10 mb-20`}
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        features: ["5 usuarios", "Gestión avanzada", "Sistema de fidelización", "Informes detallados", "Soporte prioritario"],
                                        popular: true,
                                    ...
                                    },
                                    {
                                        ...
                                        features: ["Usuarios ilimitados", "Múltiples sucursales", "Gestión de inventario", "API completa", "Soporte 24/7"],
                                        popular: false,
                                    ...
                                    >
                                        <Card
                                            className={`h-full border-2 ${plan.popular ? 'border-blue-500 shadow-xl' : 'border-gray-200'} transition-all duration-300`}>
                                            {plan.popular && (
                                                <div
                                                    className="absolute top-0 right-0 bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-4 py-1 text-sm font-medium rounded-bl-lg rounded-tr-lg">
                                                    Más popular
                                                </div>
                                            )}
                                            <CardHeader>
                                            ...
                                            <CardFooter>
                                                <Button
                                                    className={`w-full rounded-full ${plan.popular ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white' : 'bg-white border border-blue-600 text-blue-600 hover:bg-blue-50'}`}
                                                >
                                                    {plan.buttonText}
                                                </Button>
                                            </CardFooter>
                            ...
                            {[
                                {
                                    ...
                                    testimonial: "AutoTalleres ha revolucionado nuestra gestión. La eficiencia aumentó un 40% y nuestros clientes están más satisfechos.",
                                    rating: 5,
                                ...
                                },
                                {
                                    ...
                                    testimonial: "El sistema de fidelización nos ha ayudado a recuperar clientes. La plataforma es intuitiva y el soporte excelente.",
                                    rating: 5,
                                ...
                                },
                                {
                                    ...
                                    testimonial: "Gestionamos 3 talleres con más de 20 empleados. AutoTalleres ha simplificado enormemente nuestra operación diaria.",
                                    rating: 4,
                                ...
                                },
                                {
                                    ...
                                    testimonial: "La implementación fue rápida y el soporte nos ayudó en todo. Nuestros clientes valoran las notificaciones automáticas.",
                                    rating: 5,
                                ...
                                <SwiperSlide key={i}>
                                    ...
                                    >
                                        <Card
                                            className="h-full bg-white/80 backdrop-blur-sm border border-gray-100/50 shadow-sm hover:shadow-md transition-all duration-300">
                                                ...
                                                <div className="mb-4">
                                                    <div className="flex text-yellow-400">
                                                        {[...Array(5)].map((_, j) => (
                                                            <i
                                                                key={j}
                                                                className={`fas ${j < testimonial.rating ? 'fa-star' : 'fa-star-half-alt'}`}
                                                            ></i>
                                                        ))}
                                                    </div>
                                                </div>
            ...
            {/* CTA Moderno */}
            <section
                className="py-16 md:py-24 bg-gradient-to-r from-blue-600 to-cyan-500 text-white relative overflow-hidden">
                <div className="absolute inset-0 opacity-10">
                    <div
                        className="absolute inset-0 bg-[url('https://readdy.ai/api/search-image?query=abstract%20tech%20circuit%20background%20with%20white%20lines')] bg-cover bg-center"/>
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <motion.div whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                                <Button
                                    className="bg-white text-blue-600 hover:bg-gray-100 text-lg py-6 px-8 rounded-full shadow-lg">
                                    <i className="fas fa-rocket mr-2"></i>
                                    Prueba 14 días gratis
                                </Button>
                            </motion.div>
                            ...
                            <motion.div whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                                <Button variant="outline"
                                        className="border-white text-white hover:bg-white/10 text-lg py-6 px-8 rounded-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
                        <div className="lg:col-span-2">
                            ...
                            <p className="text-gray-400 mb-6">
                                La plataforma líder en gestión para talleres automotrices. Simplifica, automatiza y haz
                                crecer tu negocio.
                            </p>
            ...
            >
                <Button
                    className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 shadow-xl hover:shadow-blue-400/50 flex items-center justify-center">
