                        ...
                        <div key={index} className="flex items-center p-3 rounded-lg hover:bg-gray-50">
                            ...
                            <div className="ml-4 flex-1">
                                ...
                                <div className="flex items-center text-xs text-gray-500 mt-1">
                                    <span className="mr-3"><i
                                        className="fas fa-tools mr-1"></i> {service.service}</span>
                                    <span><i className="fas fa-car mr-1"></i> {service.vehicle}</span>
                                </div>
                            </div>
                            <Badge
                                variant={service.status === 'Confirmado' ? 'default' : 'outline'}
                                className={service.status === 'Confirmado' ? 'bg-[#4CB944] hover:bg-[#4CB944]/90' : ''}
                            >
                                {service.status}
                            </Badge>
                        </div>
